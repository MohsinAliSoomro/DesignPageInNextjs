...
import { AiTwotoneHome ,AiFillFacebook,AiTwotoneShopping} from 'react-icons/ai'
                ...
                <div className="col">
                    <div className="nav-container">
                        <div className="brand-home-nav">
                            <p><a href="#"><AiTwotoneHome size={15} color="white" />Home</a></p>
                        </div>
                        <div className="nav-links">
                            <ul>
                                <li><a href="#">Demos<IoMdArrowDropdown /></a>
                                ...
                                <li><a href="#">Drop Down<IoMdArrowDropdown /></a>
                                                    ...
                                                    <ul>
                                                        ...
                                                        <li className="nested-drop-down">
                                                            <div className="nested-link-next-drop-down">
                                                                ...
                                                                <div style={{ marginLeft: '15px', marginTop: '3px' }}><IoMdArrowDropright size={18} /></div>
                                                            </div>
                                ...
                                <li><a href="#">Mega Links<IoMdArrowDropdown /></a>
                                    <div className="demos-drop-down">
                                        <div className="container">
                                            <div className="row">
                                                <div className="col-md-3">
                                ...
                                <li><a href="#">Mega Label</a>
                                    <div className="demos-drop-down">
                                        <div className="container">
                                            <div className="row">
                                                <div className="col-md-3">
                                                    <div className="megalabel-img">
                                                        <img width="100%" src="https://images.unsplash.com/photo-1586207208775-fff3effef13e?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=966&q=80" />
                                ...
                                <li><a href="#">Complex Mega<IoMdArrowDropdown /></a>
                                    <div className="demos-drop-down">
                                        <div className="container">
                                            <div className="row">
                                                <div className="col-md-3">
                                ...
                                <li><a href="#"><FaCode />Shortcut<IoMdArrowDropdown /></a>
                                ...
                                <li><a href="#"><FaShoppingCart />Buy Now</a></li>
                            </ul>
                        </div>
                    </div>
                </div>
                                ...
                                <div className="card-img-overlay mt-5 text-white">
                                    <div className="main-carousel-img">
                                        <div className="main-crousal-icons">
                                            <FiMessageCircle size={20} color="orangered" /><span className="mr-3">5</span>
                                            <FiEdit size={20} color="orangered" /><span className="mr-3">Ten Nygeyen</span>
                                            <WiTime1 size={20} color="orangered" /><span>Jun 07,2015</span>
                                        </div>
